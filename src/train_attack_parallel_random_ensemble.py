...
def train_attack_randens(dataset_name, epochs, n_proj, size_proj, projection_mode, attacks_list, attack_library, 
...
for n_proj in n_proj_list:
    for size_proj in size_proj_list:
        K.clear_session()
        train_attack_randens(dataset_name=args.dataset_name, epochs=args.epochs, n_proj=n_proj, size_proj=size_proj,
