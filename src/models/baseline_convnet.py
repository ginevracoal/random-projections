...
class BaselineConvnet(AdversarialClassifier):
    ...
    def save_robust_classifier(self, debug, attack_method, attack_library, filename=None, filepath=None):
...
# def train_generate_eval(dataset_name, epochs, debug, attacks, seed, device, attack_library):
#     x_train, y_train, x_test, y_test, input_shape, num_classes, data_format = load_dataset(dataset_name=dataset_name,
#                                                                                            debug=debug)

#     print("\n === Baseline training === ")
#     baseline = BaselineConvnet(input_shape=input_shape, num_classes=num_classes, data_format=data_format,
#                                dataset_name=dataset_name, epochs=None, library=library)
...
#         robust_baseline.save_classifier()
...
#     """
#     # === GPU keras session === #
#     # _set_session(device=device, n_jobs=6)

#     # robust_models = [""]
#     attacks = ["fgsm","pgd","deepfool","carlini"]#"virtual","spatial","saliency"]
